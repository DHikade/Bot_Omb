...
class Language(object):
    ...
    def set_Language(self, language):
        ...
        if language == "german":
            self.__language = language
            self.__languages = {
                "language_switch" : "Die Sprache wurde geaendert zu {0}",
                "language_switch_fail" : "Die Sprache konnte nicht geaendert werden da {0} nicht gefunden wurde!",
                "language_later" : "Ein Modul laeuft gerade! Die Sprache dieses Moduls wird geaendert, sobald es fertig ist.",
                "upsince" : "Der Stream laeuft seit {0}",
                "upsince_not" : "Der Stream ist offline.",
                "privileges_check_fail" : "Dein Berechtigungslevel ist nicht hoch genug um das Kommando auszufuehren! Du brauchst mindestens ein Berechtigungslevel von {0}.",
                ...
                "poll_progress" : "Eine Umfrage laeuft gerade!",
                "poll_off" : "Zur Zeit gibt es keine Umfragen!",
                "poll_vote" : "Deine Abstimmung wurde erfolgreich angenommen!",
                "poll_vote_fail" : "Du hast fuer eine Option gestimmt, die momentan nicht in der Liste steht.",
                ...
                "greetings" : "Hallo an alle die zum ersten Mal zuschauen: {0} Ich hoffe euch gefaellt mein Stream!",
                "smm_level_list" : "Dein Super-Mario-Maker-Level-Code wurde erfolgreich zur Liste hinzugefuegt. Bitte bewahre ruhe, waehrend du auf dein Level wartest!",
                "smm_level_switch" : "Dein alter Levelcode {0} wurde mit dem Neuen getauscht {1}",
                "smm_level_list_user" : "{0} Super-Mario-Maker-Level-Code wurde erfolgreich zur Liste hinzugefuegt. Bitte bewahre ruhe, waehrend du auf dein Level wartest!",
                ...
                "smm_level_next" : "Das naechste Level welches wir spielen ist von {0} und hat den Code {1}",
                ...
                "announcement_show" : "Dies sind die Ankuendigungen des Channels und deren Werte: {0}",
                "announcement_remove" : "Die Ankuendigung {0} wurde erfolgreich vom Channel entfernt!",
                "announcement_add" : "Die Ankuendigung {0} wurde dem Channel erfolgreich hinzugefuegt!",
                ...
                "follow" : "Hey {0}, wenn du moechtest das ich deinem Stream beitrete, besuche doch einfach meinen Channel und schreibe !follow.",
                "unfollow" : "Hey {0}, wenn du moechtest das ich deinen Stream verlasse, besuche doch einfach meinen Channel und schreibe !unfollow.",
                "bet_start_seperator" : "##### Das Rennen startet #####",
                "bet_start" : "Du kannst nun im Zeitraum von drei Minuten fuer das aktuelle Rennen wetten. Um dies zu tun, schreibe einfach: !bet hh:mm:ss money",
                "bet_start_fail" : "Eine Wette laeuft gerade, warte bis es fertig ist.",
                "bet_stop" : "Der Gewinner ist {0}, mit einer geschaetzten Zeit von {1}:{2}:{3}. Du erhaelst {4} Muenzen.",
                "bet_stop_no" : "Traurigerweise hat niemand gewettet.",
                "bet_not_active" : "Aktuell laeuft keine Wette!",
                "bet_reset" : "Das Rennen wurde zurueckgesetzt!",
                "bet_reset_fail" : "Es gibt kein Rennen welches zurueckgesetzt werden koennte",
                "bet_accept" : "Deine Wette wurde erfolgreich angenommen {0}",
                "bet_same_time" : "Jemand anderes hat bereits auf diese Zeit gewettet!",
                "bet_no_coins" : "Nicht mal eine Muenze ist dir geblieben {0}. Hier eine kleine finanzielle Spritze! Du bekommst 10 Muenzen.",
                "bet_not_enough" : "{0} du hast nicht genug Muenzen zum Wetten!",
                "setting_range" : "Die Einstellungen fuer {0} duerfen sich nur im Bereich von 0 bis 99 bewegen",
                "setting_change" : "Die Einstellungen fuer {0} wurden geaendert zu {1}",
                "privileges_range" : "Achtung! Befugnislevel koennen nur im Bereich von 0 bis 99 vergeben werden!",
                ...
                "command_add_privileges" : "Befugnislevel fuer Kommandos duerfen sich nur im Bereich von 0 bis 99 bewegen!",
                "command_add" : "Das Kommando wurde erfolgreich dem Chat hinzugefuegt!",
                ...
                "warning_caps" : "{0} scheint die Capslock Taste ziemlich zu moegen <3",
                "warning_long_text" : "{0} scheint sehr lange Nachrichten zu moegen. Du solltest alternativ eine PN ueber Twitch versenden!",
                "help" : "Was moechtest du wissen? Schreibe einfach !help <command> fuer weitere Informationen.",
                "help_command" : "Du kannst eigene Kommandos hinzufuegen mit !command new_command privileges text. Als Beispiel: !command !test 0 You got it!",
                "help_bet" : "Wenn ein Rennen gestartet wurde, hast du die Moeglichkeit zu wetten. Schreibe hierfuer einfach !bet hh:mm:ss money. Als Beispiel: !bet 0:01:23 10. Wenn du vorher noch nicht gewettet hast, startest du mit 100 Muenzen!",
                "help_start" : "Startet ein neues Rennen und gibt dir die Moeglichkeit zu wetten!",
                "help_stop" : "Beendet einen Rennen und gibt jedem der gewettet hat einen gewissen Teil seines Einsatzes zurueck. Die Menge ist abhaengig von der Abweichung zur erreichten Zeit.",
                "help_reset" : "Setzt ein Rennen zurueck und jeder erhaelt sein Geld wieder.",
                "help_help" : "Dies ist die Hilfe. Hier findest du alle Informationen die du ueber die Kommandos benoetigt. Als Beispiel: !help help",
                ...
                "help_priv" : "Um eine Aktion mit dem Bot auszufuehren, benoetigst du ein bestimmtes Befugnislevel. Mit dem Kommando !priv level username, kannst du das Befugnislevel setzen. Als Beispiel: !priv 42 serdrad0x",
                "help_remove" : "Du kannst ein selbst erstelltes Kommando entfernen mit !remove command. Als Beispiel: !remove !test",
                "help_setting" : "Du kannst di Einstellungen der automatischen Moderation aendern mit !setting warning_url/warning_caps on/off.",
                "help_follow" : "Wenn du moechtest, kann der Bot dir in den Channel folgen und bei der Moderation helfen. Fuer weitere Informationen schau doch einfach mal auf dem Bot_Omb Channel vorbei.",
                "help_unfollow" : "Wenn du Bot_Omb in deinem Chat verwendest und dort nicht mehr moechtest, dann kannst du ihn einfach entfernen mit !unfollow. Fuer weitere Informationen schau doch einfach mal auf dem Bot_Omb channel.",
                "help_greetings" : "Alle x Sekunden prueft der Bot auf neue Zuschauer und prueft ob diese bereits gegruesst wurden. Um dieses Verhalten zu aendern nutze !setting greetings on/of und !setting greetings_interval 60",
                "help_poll" : "Wenn du schreibst !poll pollname (optionA / optionB) mm:ss dann kannst du eine zeitlich begrenzte Umfrage starten. !result zeigt dir die Ergebnisse und !vote num fuer das Abstimmen!",
                "help_next" : "Kuendigt das naechste Level der Super Mario Maker - Level - Liste an.",
                "help_levels" : "Zeigt alle Level die zur Super Mario Maker - Level - Liste hinzugefuegt wurden.",
                "help_submit" : "Fuegt ein Level der Super Mario Maker - Level - Liste hinzu. Ein fremdes Level kann hinzugefuegt werden ueber !submit username levelcode."
            }